...
namespace Kinetics.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "FinancialAssistanceRequests",
                columns: table => new
                {
                    ...
                    ApprovedByManager = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ApprovedByHR = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EmployeeID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FinancialAssistanceRequests", x => x.RequestID);
                    table.ForeignKey(
                        name: "FK_FinancialAssistanceRequests_Employees_EmployeeID",
                        column: x => x.EmployeeID,
                        principalTable: "Employees",
                        principalColumn: "EmployeeID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeaveApplicationRequests", x => x.LeaveID);
                    table.ForeignKey(
                        name: "FK_LeaveApplicationRequests_Employees_EmployeeID",
                        column: x => x.EmployeeID,
                        principalTable: "Employees",
                        principalColumn: "EmployeeID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinancialAssistanceRequests_EmployeeID",
                table: "FinancialAssistanceRequests",
                column: "EmployeeID");

            migrationBuilder.CreateIndex(
                name: "IX_LeaveApplicationRequests_EmployeeID",
                table: "LeaveApplicationRequests",
                column: "EmployeeID");
